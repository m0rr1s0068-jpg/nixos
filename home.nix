...

{
  ...
  # Import files from the current configuration
  #  directory into the Nix store,
  ...
  # and recursively generate symbolic links 
  #  in the Home directory pointing to the files in the store.
